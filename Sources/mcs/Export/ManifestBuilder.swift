...
struct ManifestBuilder {
    ...
    private func renderYAML(manifest: ExternalPackManifest, brewHints: [String: String]) -> String {
        ...
        yaml.comment("Schema reference: https://github.com/mcs-cli/mcs/blob/main/docs/techpack-schema.md")
        yaml.comment("Guide: https://github.com/mcs-cli/mcs/blob/main/docs/creating-tech-packs.md")
        yaml.blank()
        ...
        yaml.comment("See: https://github.com/mcs-cli/mcs/blob/main/docs/techpack-schema.md#doctor-checks")
